                                    ...
                                    for (var M in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k)
                                        if ("element" !== M) {
                                            ...
                                            if (1 === g) T = A.endValue;
                                                ...
                                                if (T = A.startValue + O * I(g, d, O), !f && T === A.currentValue) continue
                                            }
                                            if (A.currentValue = T, "tween" === M) m = T;
                                            else {
                                                if (b.Hooks.registered[M]) {
                                                    var P = b.Hooks.getRoot(M),
                                                        _ = a(C).rootPropertyValueCache[P];
                                                ...
                                                b.Hooks.registered[M] && (a(C).rootPropertyValueCache[P] = b.Normalizations.registered[P] ? b.Normalizations.registered[P]("extract", null, D[1]) : D[1]), "transform" === D[0] && (S = !0)
                                            }
                    ...
                    function r() {
                        function t(t) {
                            ...
                            if ("scroll" === T) {
                                ...
                                for (var _ in P)
                                    if ("element" !== _) {
                                        var D = P[_].startValue;
                                        P[_].startValue = P[_].currentValue = P[_].endValue, P[_].endValue = D, p.isEmptyObject(w) || (P[_].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + _ + "): " + JSON.stringify(P[_]), r)
                                    } d = P
                            } else if ("start" === T) {
                                for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (P = a(r).tweensContainer), u.each(y, function(t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(E) && !V && 0 !== R && (V = 0), c._cacheValues && P && P[E] ? (V === n && (V = P[E].endValue + P[E].unitType), z = a(r).rootPropertyValueCache[N]) : b.Hooks.registered[E] ? V === n ? (z = b.getPropertyValue(r, N), V = b.getPropertyValue(r, E, z)) : z = b.Hooks.templates[N][1] : V === n && (V = b.getPropertyValue(r, E));
                                        var H, B, j, Y = !1;
                                        if (V = (H = f(E, V))[0], j = H[1], R = (H = f(E, R))[0].replace(/^([+-\/*])=/, function(t, e) {
                                                return Y = e, ""
                                            }), B = H[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? (R /= 100, B = "em") : /^scale/.test(E) ? (R /= 100, B = "") : /(Red|Green|Blue)$/i.test(E) && (R = R / 100 * 255, B = "")), /[\/*]/.test(Y)) B = j;
                                        else if (j !== B && 0 !== V)
                                            if (0 === R) B = j;
                                            else {
                                                o = o || m();
                            ...
                            d.element && (b.Values.addClass(r, "velocity-animating"), F.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, S === C - 1 ? (v.State.calls.push([F, g, c, null, A.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : S++)
                        }
                        var o, r = this,
                    ...
                    if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                            ...
                            default:
                                if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                    if (p.isString(y) && v.Redirects[y]) {
                                        var O = (E = u.extend({}, w)).duration,
                                            P = E.delay || 0;
                                        return !0 === E.backwards && (g = u.extend(!0, [], g).reverse()), u.each(g, function(t, e) {
                                            parseFloat(E.stagger) ? E.delay = P + parseFloat(E.stagger) * t : p.isFunction(E.stagger) && (E.delay = P + E.stagger.call(e, t, C)), E.drag && (E.duration = parseFloat(O) || (/^(callout|transition)/.test(y) ? 1e3 : m), E.duration = Math.max(E.duration * (E.backwards ? 1 - t / C : (t + 1) / C), .75 * E.duration, 200)), v.Redirects[y].call(e, e, E || {}, t, C, g, A.promise ? A : n)
                                        }), t()
                                    }
                        ...
                        if (u.each(g, function(t, e) {
                            ...
                            for (var $ = 0; D > $; $++) {
                                ...
                                $ === D - 1 && (R.display = E.display, R.visibility = E.visibility, R.complete = E.complete), x(g, "reverse", R)
                            }
                        return t()
                    }
                };
                ...
                e.exports = {
                    ...
                    update: function(t, e, i) {
                        if (t) {
                            ...
                            }), O = l, P = c, _ = u, D = d, n.each(h, function(t) {
                                O += t.width
                            }), n.each(p, function(t) {
                                P += t.width
                            }), n.each(f, function(t) {
                            ...
                            var E = Math.max(M - O, 0);
                            O += E, P += Math.max(T - P, 0);
                            var L = Math.max(A - _, 0);
                            _ += L, D += Math.max(I - D, 0);
                            var F = i - _ - D,
                                $ = e - O - P;
                            $ === k && F === C || (n.each(h, function(t) {
                                t.height = F
                            }), n.each(p, function(t) {
                                t.height = F
                            }), n.each(f, function(t) {
                        ...
                        function N(t) {
                            t.isHorizontal() ? (t.left = t.fullWidth ? l : O, t.right = t.fullWidth ? e - c : O + k, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = R, t.right = R + t.width, t.top = _, t.bottom = _ + C, R = t.right)
                        }
                    }
                }
            }, {
                    ...
                    draw: function(t) {
                        ...
                        if (i.display) {
                            var o = e.ctx,
                                ...
                                O = "right" === i.position ? e.left + w : e.right,
                            ...
                            if (a.each(g, function(n, o) {
                                    if (!a.isNullOrUndef(n.label)) {
                                        ...
                                        if (m) {
                                            var V = w + W;
                                            "bottom" === i.position ? (R = f ? "middle" : "top", $ = f ? "right" : "center", L = e.top + V) : (R = f ? "middle" : "bottom", $ = f ? "left" : "center", L = e.bottom - V);
                                            var N = l(e, o, h.offsetGridLines && g.length > 1);
                                            N < e.left && (u = "rgba(0,0,0,0)"), N += a.aliasPixel(c), E = e.getPixelForTick(o) + s.labelOffset, v = b = k = S = N, y = P, x = _, C = t.top, D = t.bottom + A
                                        } else {
                                            var z, H = "left" === i.position;
                                            s.mirror ? ($ = H ? "left" : "right", z = W) : ($ = H ? "right" : "left", z = w + W), E = H ? e.right - z : e.left + z;
                                            var B = l(e, o, h.offsetGridLines && g.length > 1);
                                            B < e.top && (u = "rgba(0,0,0,0)"), B += a.aliasPixel(c), L = e.getPixelForTick(o) + s.labelOffset, v = I, b = O, k = t.left, S = t.right + A, y = x = C = D = B
                                        }
                                        T.push({
                                            tx1: v,
                                            ty1: y,
                                ...
                                var D, E, L = 0,
                                    F = d(p) / 2;
                                if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === i.position ? e.bottom - F - S.bottom : e.top + F + S.top;
                                else {
                                    var $ = "left" === i.position;
                                    D = $ ? e.left + F + S.top : e.right - F - S.top, E = e.top + (e.bottom - e.top) / 2, L = $ ? -.5 * Math.PI : .5 * Math.PI
                                }
...
dropdownSelectors.on({
    ...
    function() {
        ...
        function M(t, e) {
            var i, o, r = n(S),
                ...
                O = I ? t : t.find("input"),
                P = (O.prop("type"), n("label[for=" + O.attr("id") + "]")),
                _ = this;
            ...
            for (E = 0; E < 60; E += V)
                for (E = 0; E < 60; E += 5) L = R.clone(), F = E / 30 * Math.PI, L.css({
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, A, I, O, P, _, D, E, L, F, $, R, W, V, N, z, H, B, j, Y, q, X, U, K, Q, Z, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Ft = null,
                $t = function() {
                    Ft && (o.unbind(document, "mousemove", $t), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Ft = setTimeout(function() {
                        Ft = null
                    }, 100)
                },
                Rt = function(t, e) {
                ...
                Qt = {
                    ...
                    init: function() {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), E = t.className, s = !0, R = o.detectFeatures(), _ = R.raf, D = R.caf, I = R.transform, F = R.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                function() {
                                    if (I) {
                                        var e = R.perspective && !P;
                                        return y = "translate" + (e ? "3d(" : "("), void(b = R.perspective ? ", 0px)" : ")")
                                    }
                                    I = "left", o.addClass(t, "pswp--ie"), Pt = function(t, e) {
                                        e.left = t + "px"
                                    }, Ot = function(t) {
                            ...
                            e && (a.ui = new e(a, o)).init(), St("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= Ne()) && (u = 0), a.currItem = Ve(u), (R.isOldIOSPhone || R.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === $ && (St("initialLayout"), $ = L = o.getScrollY());
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += P ? "pswp--touch" : "pswp--notouch", c += R.animationName ? " pswp--css_animation" : "", c += R.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++) Pt((i + h) * ft.x, k[i].el.style);
                            F || o.bind(a.scrollWrap, f, a), Ct("initialZoomInEnd", function() {
                                a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), R.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", $t), o.bind(window, "resize scroll", a), St("bindEvents")
                    ...
                    close: function() {
                        s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", $t), R.transform && o.unbind(a.scrollWrap, "click", a), j && o.unbind(window, p, a), St("unbindEvents"), ze(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                        St("destroy"), Fe && clearTimeout(Fe), t.setAttribute("aria-hidden", "true"), t.className = E, x && clearInterval(x), o.unbind(a.scrollWrap, f, a), o.unbind(window, "scroll", a), pe(), Ut(), kt = null
                    },
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== mt) {
                            ...
                            if (!(t && 2 > i)) {
                                ...
                                for (var n = 0; i > n; n++) mt > 0 ? (e = k.shift(), k[2] = e, Pt((++h + 2) * ft.x, e.el.style), a.setContent(e, u - i + n + 1 + 1)) : (e = k.pop(), k.unshift(e), Pt(--h * ft.x, e.el.style), a.setContent(e, u + i - n - 1 - 1));
                                if (tt && 1 === Math.abs(mt)) {
                                    var o = Ve(C);
                                    o.initialZoomLevel !== g && (Ye(o, dt), Ke(o), Ot(o))
                                }
                    ...
                    updateSize: function(e) {
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, Bt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, _t(ft.x * ht), St("beforeResize"), void 0 !== h) {
                            for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Pt((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && Ne() > 2 && (l = wt(l)), (s = Ve(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Ke(s), Ot(s));
                            w = !1
                        }
                ...
                Se = function(t) {
                    ...
                    return O ? (st = 0, ie.forEach(function(t) {
                ...
                Te = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!B || "mousedown" !== t.type) {
                            if (ve(t, !0) && t.preventDefault(), St("pointerDown"), O) {
                            ...
                            var i = Se(t),
                                n = i.length;
                            Q = null, Ut(), j && 1 !== n || (j = nt = !0, o.bind(window, p, a), z = rt = ot = H = K = X = Y = q = !1, it = null, St("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                    ...
                    if (Q) {
                        ...
                        if (0 !== t)
                            if (Et(Zt, Q[0]), Jt.x = Zt.x - te.x, Jt.y = Zt.y - te.y, Z && t > 1) {
                                ...
                                0 > n && (n = 0), be(Zt, Gt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Et(de, se), ut.x = Dt("x", i), ut.y = Dt("y", i), z = i > g, g = i, It()
                            } else {
                                if (!it) return;
                ...
                Oe = function(t) {
                    ...
                    var e;
                    if (St("pointerUp"), ve(t, !1) && t.preventDefault(), O) {
                    ...
                    if (0 === l && (j = !1, o.unbind(window, p, a), pe(), Z ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Z && 2 > l && (Z = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Q = null, X || q || et || H)
                        if (Ut(), N || (N = Pe()), N.calculateSwipeSpeed("x"), H)
            ...
            xt("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        ...
                        (O = R.pointerEvent) && R.touch && (R.touch = !1), O ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : R.touch ? (t("touch", "start", "move", "end", "cancel"), P = !0) : t("mouse", "down", "move", "up"), p = M + " " + T + " " + A, f = S, O && !P && (P = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = P, m[S] = Te, m[M] = Ae, m[T] = Oe, A && (m[A] = m[T]), R.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[M], m.mouseup = m[T]), P || (r.allowPanToNext = !1)
                    }
                }
            });
            var Fe, $e, Re, We, Ve, Ne, ze = function(e, i, n, s) {
                    var l;
                    Fe && clearTimeout(Fe), We = !0, Re = !0, e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(u);
                    ...
                    ! function() {
                        ...
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, It()), Xt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            if (St("initialZoom" + (n ? "Out" : "In")), n) {
                                ...
                                i ? Kt("initialZoom", 0, 1, d, o.easing.cubic.out, p, h) : (p(1), Fe = setTimeout(h, d + 20))
                            } else g = e.initialZoomLevel, Et(ut, e.initialPosition), It(), Tt(1), s ? t.style.opacity = 1 : Tt(1), Fe = setTimeout(h, d + 20)
                        }, n ? 25 : 90)
                    }()
                },
                He = {},
            ...
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function() {
                        o.extend(r, je, !0), a.items = $e = i, Ve = a.getItemAt, Ne = r.getNumItemsFn, r.loop, Ne() < 3 && (r.loop = !1), Ct("beforeChange", function(t) {
                            var e, i = r.preload,
                                n = null === t || t >= 0,
                                o = Math.min(i[0], Ne()),
                                s = Math.min(i[1], Ne());
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Ke(l, n), qe(0, l, c, n));
                                ...
                                if (l.loadComplete = function(i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                if (Ue(i, !0)) return i.loadComplete = i.img = null, Ye(i, dt), Ot(i), void(t.index === u && a.updateCurrZoomItem());
                            ...
                            Re || e !== u ? Ot(l) : (tt = c.style, ze(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
                        } else t.el.innerHTML = ""
                    },
        ...
        return function(t, e) {
            var i, n, o, a, r, s, l, c, u, d, h, p, f, m, g, v, y, b, x = this,
                ...
                _ = function(e) {
                    ...
                    return t.shout("shareLinkClick", e, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), C || P(), 1))
                },
                D = function() {
            ...
            x.init = function() {
                e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
                    function() {
                        ...
                        C || P(), y && clearInterval(y), e.unbind(document, "mouseout", $), e.unbind(document, "mousemove", F), e.unbind(n, "pswpTap click", M), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
                    }), d("destroy", function() {
                    ...
                    function() {
                        ...
                        e.bind(document, "mousemove", F), e.bind(document, "mouseout", $), y = setInterval(function() {
                            2 == ++L && x.setIdle(!0)
                        }, g.timeToIdle / 2)
                ...
                k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), A(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, C || P(), I()
