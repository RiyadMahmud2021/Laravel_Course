        ...
        @foreach($serviceData as $key)
            <div class="col-md-3 p-2 ">
                <div class="card service-card text-center w-100">
                    <div class="card-body">
                        <img class="service-card-logo " src="{{$key->service_img}}" alt="Card image cap">
                        <h5 class="service-card-title mt-3">{{$key->service_name}}</h5>
                        <h6 class="service-card-subTitle p-0 m-0">{{$key->service_des}} </h6>
                    </div>
                </div>
            </div>
        @endforeach
